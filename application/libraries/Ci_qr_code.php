...
class Ci_qr_code
{
	...
	public function initialize($config = array())
	{
		...
		$this->_cachedir 		= (isset($config['cachedir'])) ? $config['cachedir'] : $config['ruta_base'].$this->_cachedir;
		$this->_error_log_dir 	= (isset($config['errorlog'])) ? $config['errorlog'] : $config['ruta_base'].$this->_error_log_dir;
		$this->_ci_qr_code_lib 	= (isset($config['ciqrcodelib'])) ? $config['ciqrcodelib'] : $config['ruta_base'].$this->_ci_qr_code_lib;
