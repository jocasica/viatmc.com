      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="table-responsive col-sm-12">
              <table class="table v-middle table-responsive" id="consulta_resumen_ventas_digemid" style="font-size: 12px">
                  <thead>
                      <tr class="bg-light">
                          ...
                          <th>Descripción de los datos de los bienes</th>
...
<form id="form-resumen-ventas-digemid" autocomplete="off">
...
<div class="modal fade" id="modal-resumen-ventas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
      ...
      <input type="month" name="periodo_inicio" class="form-control periodo_inicio" required value="<?=  date('Y-m') ?>">
      <label>hasta</label>
      <input type="month" name="periodo_fin" class="form-control periodo_fin" required value="<?=  date('Y-m') ?>">
    </div>
