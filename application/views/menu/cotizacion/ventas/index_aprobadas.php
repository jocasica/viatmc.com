				...
				<div class="d-flex align-items-center">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Lista de Cotizaciones Aprobadas</li>
						</ol>
					</nav>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="d-md-flex align-items-center">
							<div>
								<h4 class="card-title">Lista de Cotizaciones Aprobadas</h4>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td><label class="label label-success" title="Cotización aprobada">APROBADO</label></td>
											<td>
												<!-- Imprimir -->
												<?php $tipo=""; ?>
