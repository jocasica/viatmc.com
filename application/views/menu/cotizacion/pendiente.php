                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Lista de Cotizaciones pendientes</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Lista de Cotizaciones pendientes</h4>
                    </div>
                    <div class="card-body">
                        <div class="d-md-flex align-items-center">
                            <div class="table-responsive">
                                <table class="table v-middle" id="tabla-cotizaciones-pendientes">
                                    <thead>
                                        <th>#</th>
                                        <th>Fecha</th>
