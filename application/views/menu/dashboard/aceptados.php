<div class="page-wrapper" style="background-color: #D2E0F0;">
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-5">
                <h4 class="page-title">Documentos aceptados</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Documentos</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Aceptados</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table v-middle" id="boletas_aceptadas" style="font-size: 12px">
                            <thead>
                                <tr class="bg-light">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table v-middle" id="facturas_aceptadas" style="font-size: 12px">
                            <thead>
                                <tr class="bg-light">
                                    <th class="border-top-0">Serie</th>
                                    <th class="border-top-0">Número</th>
